...
<html class="no-js" lang="">
  <head>
    ...
    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href="{{ asset('frontend/css/bootstrap-5.0.0-beta1.min.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/lindy-uikit.css') }}"/>
  </head>
  <body>
    ...
    <section id="home" class="hero-section-wrapper-5">
              ...
              <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg">
                  ...
                  <div class="header-action d-flex">
                    <a href="{{ route('tasks.index') }}" style="color: red ;font-weight:bolder">  Crud</a>
      ...
      <!-- ========================= hero-5 start ========================= -->
      <div class="hero-section hero-style-5 img-bg" style="background-image: url('frontend/img/hero/hero-5/hero-bg.svg')">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="hero-content-wrapper">
                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">You're Using Free Laravel 12 Crud</h2>
                ...
                <a href="{{ route('home') }}" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">Get Started <i class="lni lni-chevron-right"></i> </a>
              </div>
            </div>
            <div class="col-lg-6 align-self-end">
              <div class="hero-image wow fadeInUp" data-wow-delay=".5s">
                <img src="{{ asset('frontend/img/hero/hero-5/hero-img.svg') }}" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-7 col-lg-6">
            <div class="about-image text-lg-right wow fadeInUp" data-wow-delay=".5s">
              <img src="{{ asset('frontend/img/about/about-4/about-img.svg') }}" alt="">
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-6">
                  <div class="single-item">
                    ...
                    <div class="text">
                      <p href="mailto">jannatflowers3@gmail.com</p>
    ...
    <footer class="footer footer-style-4">
      <div class="container">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6">
              <div class="footer-widget wow fadeInUp" data-wow-delay=".2s">
                ...
                <p class="desc">Short description for the ones who look for something new.</p>
                <ul class="socials">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
              <div class="footer-widget wow fadeInUp" data-wow-delay=".5s">
                ...
                <ul class="download-app">
                       ...
                       <li><span class="text">Elementor Desing</span></li>
                       <li><span class="text">Wordpress Desing</span></li>
                       <li><span class="text">Figma Desing</span></li>
        ...
        <div class="copyright-wrapper wow fadeInUp" data-wow-delay=".2s">
          <p>Design and Developed by <a href="jannat" rel="nofollow" target="_blank">Jannatul Ferdaush</a> </p>
        </div>
      </div>
    </footer>
    <!-- ========================= footer style-4 end ========================= -->
    ...
    <!-- ========================= JS here ========================= -->
    <script src="{{ asset('frontend/js/bootstrap-5.0.0-beta1.min.js') }}"></script>
